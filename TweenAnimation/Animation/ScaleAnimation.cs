...
namespace Eco.TweenAnimation
{
    public class ScaleAnimation : IAnimation
    {
        ...
        public Tweener Show()
        {
            _transform.localScale = _vector3Options.From;
            return _transform
                .DOScale(_vector3Options.To, _vector3Options.Duration)
        ...
        public Tweener Hide()
        {
            _transform.localScale = _vector3Options.To;
            return _transform
                .DOScale(_vector3Options.From, _vector3Options.Duration)
